...
const NAV_ITEMS = [
  ...
  { index: "Indx.02", label: "4B0UT", text: "About", href: "#about", nav: "about" },
  { index: "Indx.03", label: "PH0T0", text: "Photo", href: "#photo", nav: "photo" },
  { index: "Indx.04", label: "UPDAT3", text: "Updates", href: "#updates", nav: "updates" },
  { index: "Indx.05", label: "MU5IC", text: "Music", href: "#music", nav: "music" },
  { index: "Indx.06", label: "C0NTACT", text: "Contact", href: "#contact", nav: "contact" },
  { index: "Indx.07", label: "VIDEO5", text: "Videos", href: "https://space.bilibili.com/3493089568098826?spm_id_from=333.1007.0.0", nav: "videos" },
  { index: "Indx.08", label: "ST0RE", text: "Store", href: "#", nav: "store" },
];
...
const SOCIAL_ICONS = {
  spotify: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9.3" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M6.9 9.4c3.4-1 6.7-.7 9.8 1.1" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/><path d="M7.5 12.4c2.7-.7 5.5-.5 8 .9" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M8.1 15.2c2-.5 4-.4 5.9.6" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/></svg>`,
...
function setupVideoFallback() {
  ...
  const tryPlay = () => {
    ...
    if (playAttempt?.catch) {
      playAttempt.catch(() => {
        hero?.classList.add("hero--poster-waiting");
      });
    }
  };
  ...
  ["loadedmetadata", "canplay", "playing"].forEach((eventName) => {
    video.addEventListener(eventName, () => {
      hero?.classList.remove("hero--poster-waiting");
      tryPlay();
    });
  });
...
function primeInlineVideo(video) {
  video.muted = true;
